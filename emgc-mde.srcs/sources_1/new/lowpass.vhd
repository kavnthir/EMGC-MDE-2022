...
-- Generated on: 2023-01-23 19:00:08
-- -------------------------------------------------------------
...
ENTITY lowpass IS
   PORT( clk                             :   IN    std_logic; 
         en                              :   IN    std_logic; 
         rst                             :   IN    std_logic; 
         input                           :   IN    std_logic_vector(15 DOWNTO 0); -- sfix16_En4
         output                          :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En4
         );
...
ARCHITECTURE rtl OF lowpass IS
  ...
  -- Constants
  CONSTANT coeff1                         : signed(15 DOWNTO 0) := to_signed(16667, 16); -- sfix16_En19
  CONSTANT coeff2                         : signed(15 DOWNTO 0) := to_signed(16966, 16); -- sfix16_En19
  CONSTANT coeff3                         : signed(15 DOWNTO 0) := to_signed(17201, 16); -- sfix16_En19
  CONSTANT coeff4                         : signed(15 DOWNTO 0) := to_signed(17370, 16); -- sfix16_En19
  CONSTANT coeff5                         : signed(15 DOWNTO 0) := to_signed(17472, 16); -- sfix16_En19
  CONSTANT coeff6                         : signed(15 DOWNTO 0) := to_signed(17506, 16); -- sfix16_En19
  CONSTANT coeff7                         : signed(15 DOWNTO 0) := to_signed(17472, 16); -- sfix16_En19
  CONSTANT coeff8                         : signed(15 DOWNTO 0) := to_signed(17370, 16); -- sfix16_En19
  CONSTANT coeff9                         : signed(15 DOWNTO 0) := to_signed(17201, 16); -- sfix16_En19
  CONSTANT coeff10                        : signed(15 DOWNTO 0) := to_signed(16966, 16); -- sfix16_En19
  CONSTANT coeff11                        : signed(15 DOWNTO 0) := to_signed(16667, 16); -- sfix16_En19

  -- Signals
  SIGNAL delay_pipeline                   : delay_pipeline_type(0 TO 10); -- sfix16_En4
  SIGNAL product11                        : signed(30 DOWNTO 0); -- sfix31_En31
  SIGNAL mul_temp                         : signed(31 DOWNTO 0); -- sfix32_En23
  SIGNAL product10                        : signed(30 DOWNTO 0); -- sfix31_En31
  SIGNAL mul_temp_1                       : signed(31 DOWNTO 0); -- sfix32_En23
  SIGNAL product9                         : signed(30 DOWNTO 0); -- sfix31_En31
  SIGNAL mul_temp_2                       : signed(31 DOWNTO 0); -- sfix32_En23
  SIGNAL product8                         : signed(30 DOWNTO 0); -- sfix31_En31
  SIGNAL mul_temp_3                       : signed(31 DOWNTO 0); -- sfix32_En23
  SIGNAL product7                         : signed(30 DOWNTO 0); -- sfix31_En31
  SIGNAL mul_temp_4                       : signed(31 DOWNTO 0); -- sfix32_En23
  SIGNAL product6                         : signed(30 DOWNTO 0); -- sfix31_En31
  SIGNAL mul_temp_5                       : signed(31 DOWNTO 0); -- sfix32_En23
  SIGNAL product5                         : signed(30 DOWNTO 0); -- sfix31_En31
  SIGNAL mul_temp_6                       : signed(31 DOWNTO 0); -- sfix32_En23
  SIGNAL product4                         : signed(30 DOWNTO 0); -- sfix31_En31
  SIGNAL mul_temp_7                       : signed(31 DOWNTO 0); -- sfix32_En23
  SIGNAL product3                         : signed(30 DOWNTO 0); -- sfix31_En31
  SIGNAL mul_temp_8                       : signed(31 DOWNTO 0); -- sfix32_En23
  SIGNAL product2                         : signed(30 DOWNTO 0); -- sfix31_En31
  SIGNAL mul_temp_9                       : signed(31 DOWNTO 0); -- sfix32_En23
  SIGNAL product1                         : signed(30 DOWNTO 0); -- sfix31_En31
  SIGNAL mul_temp_10                      : signed(31 DOWNTO 0); -- sfix32_En23
...
BEGIN
  ...
  product11 <= (30 => '0', OTHERS => '1') WHEN mul_temp(31) = '0' AND mul_temp(30 DOWNTO 22) /= "000000000"
      ELSE (30 => '1', OTHERS => '0') WHEN mul_temp(31) = '1' AND mul_temp(30 DOWNTO 22) /= "111111111"
      ELSE (resize(mul_temp & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 31));

  mul_temp_1 <= delay_pipeline(9) * coeff10;
  product10 <= (30 => '0', OTHERS => '1') WHEN mul_temp_1(31) = '0' AND mul_temp_1(30 DOWNTO 22) /= "000000000"
      ELSE (30 => '1', OTHERS => '0') WHEN mul_temp_1(31) = '1' AND mul_temp_1(30 DOWNTO 22) /= "111111111"
      ELSE (resize(mul_temp_1 & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 31));

  mul_temp_2 <= delay_pipeline(8) * coeff9;
  product9 <= (30 => '0', OTHERS => '1') WHEN mul_temp_2(31) = '0' AND mul_temp_2(30 DOWNTO 22) /= "000000000"
      ELSE (30 => '1', OTHERS => '0') WHEN mul_temp_2(31) = '1' AND mul_temp_2(30 DOWNTO 22) /= "111111111"
      ELSE (resize(mul_temp_2 & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 31));

  mul_temp_3 <= delay_pipeline(7) * coeff8;
  product8 <= (30 => '0', OTHERS => '1') WHEN mul_temp_3(31) = '0' AND mul_temp_3(30 DOWNTO 22) /= "000000000"
      ELSE (30 => '1', OTHERS => '0') WHEN mul_temp_3(31) = '1' AND mul_temp_3(30 DOWNTO 22) /= "111111111"
      ELSE (resize(mul_temp_3 & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 31));

  mul_temp_4 <= delay_pipeline(6) * coeff7;
  product7 <= (30 => '0', OTHERS => '1') WHEN mul_temp_4(31) = '0' AND mul_temp_4(30 DOWNTO 22) /= "000000000"
      ELSE (30 => '1', OTHERS => '0') WHEN mul_temp_4(31) = '1' AND mul_temp_4(30 DOWNTO 22) /= "111111111"
      ELSE (resize(mul_temp_4 & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 31));

  mul_temp_5 <= delay_pipeline(5) * coeff6;
  product6 <= (30 => '0', OTHERS => '1') WHEN mul_temp_5(31) = '0' AND mul_temp_5(30 DOWNTO 22) /= "000000000"
      ELSE (30 => '1', OTHERS => '0') WHEN mul_temp_5(31) = '1' AND mul_temp_5(30 DOWNTO 22) /= "111111111"
      ELSE (resize(mul_temp_5 & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 31));

  mul_temp_6 <= delay_pipeline(4) * coeff5;
  product5 <= (30 => '0', OTHERS => '1') WHEN mul_temp_6(31) = '0' AND mul_temp_6(30 DOWNTO 22) /= "000000000"
      ELSE (30 => '1', OTHERS => '0') WHEN mul_temp_6(31) = '1' AND mul_temp_6(30 DOWNTO 22) /= "111111111"
      ELSE (resize(mul_temp_6 & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 31));

  mul_temp_7 <= delay_pipeline(3) * coeff4;
  product4 <= (30 => '0', OTHERS => '1') WHEN mul_temp_7(31) = '0' AND mul_temp_7(30 DOWNTO 22) /= "000000000"
      ELSE (30 => '1', OTHERS => '0') WHEN mul_temp_7(31) = '1' AND mul_temp_7(30 DOWNTO 22) /= "111111111"
      ELSE (resize(mul_temp_7 & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 31));

  mul_temp_8 <= delay_pipeline(2) * coeff3;
  product3 <= (30 => '0', OTHERS => '1') WHEN mul_temp_8(31) = '0' AND mul_temp_8(30 DOWNTO 22) /= "000000000"
      ELSE (30 => '1', OTHERS => '0') WHEN mul_temp_8(31) = '1' AND mul_temp_8(30 DOWNTO 22) /= "111111111"
      ELSE (resize(mul_temp_8 & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 31));

  mul_temp_9 <= delay_pipeline(1) * coeff2;
  product2 <= (30 => '0', OTHERS => '1') WHEN mul_temp_9(31) = '0' AND mul_temp_9(30 DOWNTO 22) /= "000000000"
      ELSE (30 => '1', OTHERS => '0') WHEN mul_temp_9(31) = '1' AND mul_temp_9(30 DOWNTO 22) /= "111111111"
      ELSE (resize(mul_temp_9 & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 31));

  mul_temp_10 <= delay_pipeline(0) * coeff1;
  product1 <= (30 => '0', OTHERS => '1') WHEN mul_temp_10(31) = '0' AND mul_temp_10(30 DOWNTO 22) /= "000000000"
      ELSE (30 => '1', OTHERS => '0') WHEN mul_temp_10(31) = '1' AND mul_temp_10(30 DOWNTO 22) /= "111111111"
      ELSE (resize(mul_temp_10 & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 31));
  ...
  output <= std_logic_vector(output_register);
END rtl;
